...
bnf_model_dir="models_d40/nnet3/9lang"
global_extractor="models_d40/multi/nnet3/extractor"
...
if $has_spkids; then
    database_keywords="/home/ewaldvdw/projects/unglobalpulse/ZeroResource/luganda_kws_dataset/luganda-keywords/with_spk_ids"
    database_utterances="/home/ewaldvdw/projects/unglobalpulse/ZeroResource/luganda_kws_dataset/luganda-transcribed/with_spk_ids"
else
    database_keywords="/home/ewaldvdw/projects/unglobalpulse/ZeroResource/luganda_kws_dataset/luganda-keywords/no_spk_ids"
    database_utterances="/home/ewaldvdw/projects/unglobalpulse/ZeroResource/luganda_kws_dataset/luganda-transcribed/no_spk_ids"
fi

local/prepare_data_luganda_kws.sh --has_spkids "${has_spkids}" $database_keywords $database_utterances $datadir || exit 1
...
for aset in dev test train keywords; do
    dump_bnf_dir="bnf/${aset}"
    data_hires_dir="data/${aset}_hires"
    data_hires_pitch_dir="data/${aset}_hires_pitch"
    data_bnf_dir="data/${aset}_bnf"
    ivector_dir=exp/ivectors/${aset}
